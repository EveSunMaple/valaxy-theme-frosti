<p align="center">
valaxy-theme-frosti<sup><em>(vue)</em></sup>
</p>

[![npm](https://img.shields.io/npm/v/valaxy-theme-frosti)](https://www.npmjs.com/package/valaxy-theme-frosti)
[![npm dev dependency version](https://img.shields.io/npm/dependency-version/valaxy-theme-frosti/dev/valaxy)](https://github.com/YunYouJun/valaxy)
...
```bash
npx degit YunYouJun/valaxy-theme-frosti valaxy-theme-name
...
- [ ] Rename `valaxy-theme-frosti` to `valaxy-theme-<name>` (custom it)
...
Rename `valaxy-theme-frosti` with `valaxy-theme-name` in the `package.json` and `valaxy.config.ts` files.
